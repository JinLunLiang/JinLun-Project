...
## About
Hi, I'm Liang Jin Lun! As a dedicated and analytical transitioning into the field of data analytics, I bring a unique perspective rooted in my diverse background and commitment to data-driven decision-making. With a strong foundation in [mention any relevant previous field/skills, e.g., business insights, project management, software development], I am now focusing on the art and science of data analysis to uncover insights that drive impact. My portfolio demonstrates my proficiency in SQL, R, and data visualization, showcasing my ability to transform complex datasets into actionable information.

In my projects, you will find a mix of real-world datasets and simulated scenarios that reflect current industry challenges. Each project is designed to highlight key competencies such as dynamic SQL querying, advanced data visualization, and the use of analytical tools to extract trends and patterns. Whether analyzing shopping trends or exploring housing market data, my work exemplifies my dedication to uncovering meaningful insights and my passion for data analytics.
